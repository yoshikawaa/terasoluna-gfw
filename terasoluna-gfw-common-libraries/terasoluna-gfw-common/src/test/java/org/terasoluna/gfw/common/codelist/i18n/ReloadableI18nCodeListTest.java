...
public class ReloadableI18nCodeListTest {

    static final Map<Locale, String> locales = ImmutableMap.of(Locale.ENGLISH, "label%03d", Locale.JAPANESE, "ラベル%03d");
    ...
    ReloadableI18nCodeList reloadableI18nCodeList;
    ...
    public void setUp() throws Exception {
        ...
        for (Entry<Locale, String> locale : locales.entrySet()) {
            for (int i = 0; i < 10; i++) {
                tableInput.put(locale.getKey(), String.format("%03d", i), String.format(locale.getValue(), i));
            }
        }
        ...
        for (Entry<String, String> column : tableInput.row(Locale.ENGLISH).entrySet()) {
            jdbcTemplate.update("INSERT INTO codelist_en (code_id, code_name) VALUES (:code_id, :code_name)",
        ...
        for (Entry<String, String> column : tableInput.row(Locale.JAPANESE).entrySet()) {
            jdbcTemplate.update("INSERT INTO codelist_ja (code_id, code_name) VALUES (:code_id, :code_name)",
                    ImmutableMap.of("code_id", column.getKey(), "code_name", column.getValue()));
        }
        ...
        reloadableI18nCodeList = new ReloadableI18nCodeList();
        reloadableI18nCodeList.setBeanName("CL_TEST");
        reloadableI18nCodeList.setRowsByCodeList(ImmutableMap.<Locale, ReloadableCodeList>of(Locale.ENGLISH,
    ...
    public void testSetRowsByCodeListWithLocaleNull() {

        afterPropertiesSet();
        reloadableI18nCodeList.asMap(null);
    }
    ...
    public void testRefresh() {
        ...
        // after refresh of children codelist.
        codeListEnglish.refresh();
        codeListJapanese.refresh();

        assertCodeListMap(10);

        // after refresh of parent codelist.
    ...
    public void testLazyInit() {
        ...
        assertThat(ReflectionTestUtils.getField(reloadableI18nCodeList, "codeListTable"), nullValue());
        assertCodeListMap(10);
    }
